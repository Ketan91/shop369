...
//    var influencer_commission_percentage = '<?php echo $influencer_commission_percentage; ?>';
   ...
   $(document).ready(function () {
        getInfluencerProducts(apiVersion,ENCODING,access_code,partner_id,type,product_category, startfrom,maxresults);
    });
    ...
    function getInfluencerProducts(apiVersion,ENCODING,access_code,partner_id,type,product_category, start_from,max_results){
        if(start_from==0){
